...
#define RS485_RE1  GPIO_Pin_0		 //PB12

#define RS485_PORT1	GPIOB
#define RS485_ENPORT GPIOC

//#define RS485_DE1_HIGHT		GPIO_SetBits(RS485_PORT1, RS485_DE1)
//#define RS485_DE1_LOW 		GPIO_ResetBits(RS485_PORT1, RS485_DE1)

#define RS485_RE1_HIGHT		GPIO_SetBits(RS485_ENPORT, RS485_RE1)
#define RS485_RE1_LOW 		GPIO_ResetBits(RS485_ENPORT, RS485_RE1)
